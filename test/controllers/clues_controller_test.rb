...
class CluesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clue" do
    assert_difference('Clue.count') do
      post clues_url, params: { clue: { body: @clue.body, category: @clue.category, game_id: @clue.game_id, player_id: @clue.player_id } }
    end
  ...
  test "should update clue" do
    patch clue_url(@clue), params: { clue: { body: @clue.body, category: @clue.category, game_id: @clue.game_id, player_id: @clue.player_id } }
